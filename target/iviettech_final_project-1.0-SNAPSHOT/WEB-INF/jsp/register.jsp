      ...
      <div class="col-lg-12">
        <c:if test="${errorSignIn != null}">
          <div class="alert alert-danger">
            <p style="font-size: 1rem; text-align: center;">${errorSignIn}</p>
          </div>
        </c:if>
        <div class="login_form_inner">
          <h3>Register</h3>
          <form:form class="row login_form" action="register" method="post" id="contactForm"
                novalidate="novalidate" modelAttribute="accounts">
            <div class="col-md-12 form-group">
              <form:input path="firstName" type="text" class="form-control" id="fname" name="fname" placeholder="First Name"
                     onfocus="this.placeholder = ''" onblur="this.placeholder = 'Firstname'"/>
            </div>
            <div class="col-md-12 form-group">
              <form:input path="lastName" type="text" class="form-control" id="lname" name="lname" placeholder="Last Name"
