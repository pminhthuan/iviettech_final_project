    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container" style="margin-top: 60px;">
                <%--                <h2>${msg}</h2>--%>
                <div class="col-md-4">
                    <form:form action="${action}" method="post" modelAttribute="manufactor">
                        <fieldset class="scheduler-border">
                            <legend class="scheduler-border"><c:out value="${msg}"/></legend>
                            <c:if test="${type.equals('updateManufactor')}">
...
<%--                                    <form:hidden path="id" />--%>
                            ...
                            <div class="form-group">
                                <label class="control-label">Manufactor name (*)</label>
                                <form:input path="name" type="text" class="form-control" placeholder="Manufactor name" required="true"/>
                            </div>
                            <br>
