...
<%--                                <button id="add2cart_btn" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 js-addcart-detail">--%>
<%--                                    Add to cart--%>
<%--                                </button>--%>
...
<script type="text/javascript">
    ...
    $('#size').change(function () {
        ...
        $(this).find('option:not(:selected)').removeAttr('id', product_size);
        ...
        $('#size option').each(function () {
            console.log('Option value: ' + $(this).text() + ' _ ID: ' + $(this).attr('id'));
        });
    });
